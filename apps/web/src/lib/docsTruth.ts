...
export const TOOLS = [
  ...
  { name: 'till_run_mission', purpose: 'OPERATOR rail: API operator signs USDC.e, not the browser session. Labeled. No owner key. No session key.', args: 'subject, tokenId?', spend: true, policy: false, revoke: false, scope: 'till.mission.execute' },
  ...
  { name: 'till_review', purpose: 'Compile Review This. Does not pay unless a SETTLED SKU is quoted.', args: 'subject', spend: false, policy: false, revoke: false, scope: 'till.mission.create' },
